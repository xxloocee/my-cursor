...
SELECT
    ...
    base_url, use_full_url, api_key, tooltip_data, model_id,
    CASE
        WHEN reasoning_effort IS NOT NULL
          OR anthropic_thinking_effort IS NOT NULL
          OR thinking_budget_tokens IS NOT NULL
        THEN 1 ELSE 0
    END,
    0, 0,
